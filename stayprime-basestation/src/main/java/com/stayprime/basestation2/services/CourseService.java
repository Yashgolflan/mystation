...
public class CourseService {
    ...
    public void saveClients(ArrayList<Clients> clients) {
        ...
        /* 
          ...
          added by Javed on  03-04-19
          for updating the UI of --On Course Ads-- 
          for newly added ad
         */
        //   localStorage.saveClients(clients);
    ...
    /*
        Commented by javed on 05-04-19
        this is the old code
        for updating the UI active check box
     */
//    public void deleteClient(Clients client) {
//        clientsRepo.delete(client);
//        assetUpdated(Constants.adsUpdated, new Date());
//    }
    public void deleteClient(Clients client, ArrayList<Clients> clients) {
        clientsRepo.delete(client);
        /*
          for loop & localStorage.saveClients(clients);
          added by Javed on 04-04-19
          for updating the UI of --On Course Ads-- 
          for deleting the ad
         */
        for (int i = 0; i < clients.size(); i++) {
            Clients tempClient = clients.get(i);
