...
public class MenuTableFormat implements AdvancedTableFormat<MenuItems>, WritableTableFormat<MenuItems> {
    ...
    private MenuItems parsePrice(MenuItems e, String s) {
        ...
        try{
            ...
            try {
                e.setPrice(priceFormat.parse("0").floatValue());
            } catch (ParseException ex) {
                Logger.getLogger("line 170 MenuTableFormat"+MenuTableFormat.class.getName()).log(Level.SEVERE, null, ex);
            }
            System.out.println("Line 170 MenuTableFormat"+e1.toString());
        }
        return e;
    }
