...
public class MainPanel extends javax.swing.JPanel implements ScreenParent {
    ...
    /**
     * Inits UI and ties components together. This method is separated from the
     * constructor to avoid initialization problems with NetBeans GUI editor.
     */
    public void init() {
...
//    }
    ...
    public void setGolfClub(GolfClub golfClub) {
        ...
        if (golfClub != null) {
            System.out.println("====="+golfClub.getLogoImage()+"");
    ...
    private void initComponents() {
        ...
        cartStatusButton.setToolTipText(resourceMap.getString("cartStatusButton.toolTipText")); // NOI18N
        ...
        onCourseAdsButton.setToolTipText(resourceMap.getString("onCourseAdsButton.toolTipText")); // NOI18N
        ...
        cartStatusSidebarLayout.setVerticalGroup(
            ...
            .addGroup(cartStatusSidebarLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cartStatusTabsPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 374, Short.MAX_VALUE))
        );
    ...
    public void showCartStatus(ActionEvent e) {
        ...
        //   cartStatusButton.setFocusPainted(Boolean.FALSE);
    ...
    public void showOnCourseAdsPanel() {
        onCourseAdsButton.setOpaque(true);
        onCourseAdsButton.setSelected(true);
    ...
    public void administratorLogin() {
        ...
        if (loginDialog.isConnected()) {
            int a = JOptionPane.showConfirmDialog(this, "Are you Sure you want to logout", "Log Out", JOptionPane.YES_NO_OPTION);
            if (a == 0) {
                loginDialog.disconnect();
                loginDialog.setUser(null);
                adminButton.setText("Administrator");
                showDashboardPanel();
            }
        } else {
            boolean result = loginDialog.connect();
            if (result) {
               
                adminButton.setText(loginDialog.getUsername());
            }
