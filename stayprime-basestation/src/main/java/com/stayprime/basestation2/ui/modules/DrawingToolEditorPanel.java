...
//    }
    ...
    public void editShapePoints1(boolean value){
        setEditingShapePoints(value);
    }
    ...
    private void initComponents() {
        ...
        opacitySlider.setPreferredSize(new java.awt.Dimension(0, 50));
        ...
        shapeEditPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(shapeEditPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(colorComboBox, javax.swing.GroupLayout.DEFAULT_SIZE, 137, Short.MAX_VALUE))
        );
        shapeEditPanel2Layout.setVerticalGroup(
            ...
            .addGroup(shapeEditPanel2Layout.createSequentialGroup()
                ...
                .addGroup(shapeEditPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, shapeEditPanel2Layout.createSequentialGroup()
                        .addComponent(opacityLabel)
                        .addGap(11, 11, 11)))
                .addContainerGap())
        );
