...
//            webButton.setText(FileUtils.getDisplayFileName(selectedFile));
    ...
    private void init() {
        Date date = new Date();
        xDatePicker1.getMonthView().setUpperBound(date);
        xDatePicker2.getMonthView().setUpperBound(date);
    ...
    private void loadReport() {
        ...
        String reportLocation = "/com/stayprime/basestation2/resources/" + reportType.toString().toLowerCase() + ".jrxml";
          if(xDatePicker1.getDate()==null||xDatePicker2.getDate()==null){
            NotificationPopup.showErrorDialog("Date cannot be LeftEmpty");
       ...
       cal.setTime(xDatePicker2.getDate());
       cal.add(Calendar.DATE, 1);
       xDatePicker2.setDate(cal.getTime());
        dateParameter2 = new Timestamp(cal.getTimeInMillis());
      
        if(dateParameter1.after(dateParameter2)){
            NotificationPopup.showErrorDialog("Date Range query is out of Bounds\n Please check the query Range");
            generateReportButton.setEnabled(true);
            return;
        }
    ...
    private void setFontColor() {
       xDatePicker1.getMonthView().setDayForeground(Calendar.MONDAY, Color.BLACK);
       xDatePicker1.getMonthView().setDayForeground(Calendar.TUESDAY, Color.BLACK);
       xDatePicker1.getMonthView().setDayForeground(Calendar.WEDNESDAY, Color.BLACK);
       xDatePicker1.getMonthView().setDayForeground(Calendar.THURSDAY, Color.BLACK);
       xDatePicker1.getMonthView().setDayForeground(Calendar.FRIDAY, Color.BLACK);
       xDatePicker1.getMonthView().setDayForeground(Calendar.SATURDAY, Color.BLACK);
       xDatePicker1.getMonthView().setDayForeground(Calendar.SUNDAY, Color.BLACK);
       xDatePicker2.getMonthView().setDayForeground(Calendar.MONDAY, Color.BLACK);
       xDatePicker2.getMonthView().setDayForeground(Calendar.TUESDAY, Color.BLACK);
       xDatePicker2.getMonthView().setDayForeground(Calendar.WEDNESDAY, Color.BLACK);
       xDatePicker2.getMonthView().setDayForeground(Calendar.THURSDAY, Color.BLACK);
       xDatePicker2.getMonthView().setDayForeground(Calendar.FRIDAY, Color.BLACK);
       xDatePicker2.getMonthView().setDayForeground(Calendar.SATURDAY, Color.BLACK);
       xDatePicker2.getMonthView().setDayForeground(Calendar.SUNDAY, Color.BLACK);
