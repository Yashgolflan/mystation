...
--
-- Table structure for table `carts_ahead`
--

DROP TABLE IF EXISTS `carts_ahead`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `carts_ahead` (
  `course` smallint(5) unsigned NOT NULL,
  `hole` smallint(5) unsigned NOT NULL,
  `cart_locations` longtext NOT NULL,
  PRIMARY KEY (`course`,`hole`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `huts_holes`
--

DROP TABLE IF EXISTS `huts_holes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `huts_holes` (
  `hut_id` int(10) NOT NULL,
  `hole_id` int(11) NOT NULL,
  KEY `huts_id_idx` (`hut_id`),
  CONSTRAINT `huts_id` FOREIGN KEY (`hut_id`) REFERENCES `huts_info` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `stayprime`.`user_login` (`user_name`, `password`, `first_name`, `last_name`) VALUES ('stayprime', 'golfcart', 'stayprime', '');
...
-- Dump completed on 2015-03-19 16:52:35
