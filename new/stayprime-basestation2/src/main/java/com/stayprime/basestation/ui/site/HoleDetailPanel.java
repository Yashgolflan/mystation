...
public class HoleDetailPanel extends EditorPanel<Holes> {
    ...
    private void initComponents() {
        ...
        setLayout(new FormLayout(
            ...
            "3*(default, $lgap), default, $rgap, default, 1dlu, fill:[80dlu,pref]"));
        ...
        add(protipsField, CC.xywh(3, 7, 3, 1));
        ...
        add(protipsEditButton, CC.xy(7, 7));
        ...
        add(holeTeeBoxEditor, CC.xywh(1, 11, 7, 1));
