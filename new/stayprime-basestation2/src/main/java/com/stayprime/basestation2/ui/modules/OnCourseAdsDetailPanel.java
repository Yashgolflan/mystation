...
//	    TaskDialogs.showException(new RuntimeException("Error loading Ad image", t));
    ...
    private void initComponents() {
        ...
        imagePanel.setBorder(javax.swing.BorderFactory.createLineBorder(resourceMap.getColor("imagePanel.border.lineColor"))); // NOI18N
        ...
        contractsTabPanel.setBorder(javax.swing.BorderFactory.createLineBorder(resourceMap.getColor("contractsTabPanel.border.lineColor"))); // NOI18N
        ...
        contractsTabPanelLayout.setHorizontalGroup(
            ...
            .addGroup(contractsTabPanelLayout.createSequentialGroup()
                ...
                .addComponent(holeSponsorButton, javax.swing.GroupLayout.DEFAULT_SIZE, 182, Short.MAX_VALUE))
            .addGroup(contractsTabPanelLayout.createSequentialGroup()
                .addComponent(newContractButton, javax.swing.GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(deleteContractButton, javax.swing.GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE))
            .addComponent(contractsScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 284, Short.MAX_VALUE)
        );
        contractsTabPanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, contractsTabPanelLayout.createSequentialGroup()
                .addComponent(contractsScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 56, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(adsSeparator, javax.swing.GroupLayout.DEFAULT_SIZE, 592, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(adsTableScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 136, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(deleteAdButton)
                            .addComponent(newAdButton)))
                    .addComponent(adDetailTabbedPane, javax.swing.GroupLayout.DEFAULT_SIZE, 171, Short.MAX_VALUE)))
        );
    ...
    private static class AdsTableFormat implements WritableTableFormat<Ads> {
        ...
        public String getColumnName(int column) {
            ...
            if(column == i++) return "Type";
            if(column == i++) return "Category";
            if(column == i++) return "Contract";
        ...
        public Object getColumnValue(Ads ad, int column) {
            int i = 0;
            if(column == i++) return ad.getName();
            if(column == i++) return ad.getType();
            if(column == i++) return "NA";
            if(column == i++) return describeContracts(ad);
            throw new IllegalArgumentException();
        }
        ...
        public Ads setColumnValue(Ads ad, Object editedValue, int column) {
            int i = 0;
            if(column == i++) ad.setName((String) editedValue);
            if(column == i++) ad.setType((Integer) editedValue);
            if(column == i++) ad.setCategory(1);
            return ad;
        }
    ...
    private static class ContractsTableFormat implements WritableTableFormat<Contracts> {
        ...
        public String getColumnName(int column) {
            int i = 0;
            if(column == i++) return "Start";
            if(column == i++) return "End";
            if(column == i++) return "Plan";
            throw new IllegalArgumentException();
        }
        ...
        public Object getColumnValue(Contracts contract, int column) {
            int i = 0;
            if(column == i++) return contract.getStartDate();
            if(column == i++) return contract.getEndDate();
            if(column == i++) return contract.getPlan();
            throw new IllegalArgumentException();
        }
        ...
        public Contracts setColumnValue(Contracts contract, Object editedValue, int column) {
            int i = 0;
            if(column == i++) contract.setStartDate((Date) editedValue);
            if(column == i++) contract.setEndDate((Date) editedValue);
            if(column == i++) contract.setPlan(((Integer)editedValue).byteValue());
            return contract;
        }
    }
