...
public class VerticalLayout2 implements LayoutManager {
...
* @param vgap An int value indicating the vertical seperation of the
     * components
     */
    public VerticalLayout2(int vgap) {
...
* @param vgap An int value indicating the vertical seperation of the
     ...
     */
    public VerticalLayout2(int vgap, int alignment) {
...
* @param vgap An int value indicating the vertical seperation of the
     ...
     */
    public VerticalLayout2(int vgap, int alignment, int anchor) {
	this.vgap = vgap;
