 ...
 */
public class ComboBoxProperty implements PropertySupport {
    ...
    public void setSessionState(Component c, Object state) {
        ...
        if (state instanceof ComboBoxState) {
            JComboBox b = (JComboBox) c;
            ComboBoxState tbs = (ComboBoxState) state;
            int index = tbs.getSelectedIndex();
            if(index >= 0 && index < b.getItemCount())
